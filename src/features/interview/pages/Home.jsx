                ...
                <div className='interview-card__body'>
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            <label
                                className={`dropzone ${selectedResumeFile ? 'dropzone--has-file' : ''}`}
                                htmlFor='resume'
                            ...
                            {selectedResumeFile && (
                                <div className='attached-files'>
                                    <div className='attached-file'>
                                        ...
                                        <div className='attached-file__details'>
                                            <span className='attached-file__name'>{selectedResumeFile.name}</span>
                                            <span className='attached-file__meta'>1 file attached &bull; {formatFileSize(selectedResumeFile.size)}</span>
                                        </div>
                                        <button
                                            type='button'
